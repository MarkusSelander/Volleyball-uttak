...
function PlayerCard({
  ...
  return (
    <div
      ...
      <button
        type="button"
        className="p-2 md:p-1.5 text-gray-400 hover:text-gray-600 cursor-grab active:cursor-grabbing touch-manipulation select-none min-w-[44px] min-h-[44px] md:min-w-[28px] md:min-h-[28px] flex items-center justify-center rounded-lg hover:bg-gray-200 active:bg-gray-300 transition-colors"
      ...
      <div className="flex flex-col items-center gap-1 mr-1">
        <button
          ...
          disabled={isSaving}
          className="w-9 h-9 md:w-8 md:h-8 flex items-center justify-center rounded-full text-yellow-600 hover:text-yellow-700 bg-yellow-50 hover:bg-yellow-100 border border-yellow-200 transition-colors touch-manipulation min-w-[44px] min-h-[44px] md:min-w-[32px] md:min-h-[32px]"
      ...
      <select
        className="border border-gray-300 rounded-lg px-2 md:px-2 py-2 md:py-1.5 bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm md:text-xs font-medium text-gray-700 hover:border-blue-400 w-[100px] md:w-[100px] min-h-[44px] md:min-h-[32px] touch-manipulation"
        defaultValue=""
